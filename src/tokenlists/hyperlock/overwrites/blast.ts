...
export const blastOverrides = {
  [Network.Blast]: {
    ...
    ...{ // points
      ...
      '0x0000000000000000000000000000000000000011': getPointsToken('ETHENA', '0x00000000000000000000000000000000000000011'),
      '0x0000000000000000000000000000000000000012': getPointsToken('TURTLE', '0x00000000000000000000000000000000000000012'),
    },
    // prettier-ignore
    ...{ // yield
